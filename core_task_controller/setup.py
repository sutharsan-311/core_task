...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'goal_collector = core_task_controller.goal_collector:main',
            'nlm_interface = core_task_controller.nlm_interface:main',
            'nlm_cli = core_task_controller.nlm_cli:main',
            'squad_coordinator = core_task_controller.squad_coordinator:main',
            'tf_bridge = core_task_controller.tf_bridge:main',
        ],
    },
)
